...
export default function Chat() {
  ...
  useEffect(() => {
    if (isJoined && name) {
      ...
      // Join the chat
      newSocket.emit("join", { name, userType: "client" });
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col md:flex-row transition-colors duration-300">
      ...
      <div className="flex-1 flex flex-col">
        {/* Header */}
        <Card className="rounded-none bg-blue-500 dark:bg-blue-900 text-white p-4 flex flex-col md:flex-row md:items-center md:justify-between shadow-none border-0">
          <div>
            <h1 className="text-xl font-bold">
              Client Chat - Welcome, {name}!
            </h1>
          ...
          <Button
            ...
            className="ml-auto mt-4 md:mt-0 text-white hover:bg-blue-700 dark:hover:bg-blue-800"
            ...
            <div
              ...
              <Card
                className={`p-3 rounded-lg max-w-xs break-words shadow-sm border-0
                  ${
                    msg.sender === name
                      ? "bg-blue-500 text-white ml-auto dark:bg-blue-700"
                      : msg.sender === "System"
        ...
        <form onSubmit={handleSendMessage} className="p-4 border-t bg-card">
          <div className="flex space-x-2">
            ...
            <Button
              type="submit"
              className="bg-blue-500 text-white px-6 py-2 rounded-md hover:bg-blue-600 dark:bg-blue-700 dark:hover:bg-blue-800">
              Send
            </Button>
          </div>
        </form>
